(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[{id:`flow`,index:`01`,title:`Flowbase`,type:`B2B SaaS / Product website`,role:`Strategy, UX, UI`,image:`./images/flow-saas.webp`,color:`#d8ff5f`,statement:`複雑な業務管理を、3分で理解できる導入体験へ。`,challenge:`機能が多く、初見ユーザーが自分向けの価値を見つけにくい状態を想定。営業資料に頼らず、サイト単体で比較検討を前に進める必要がありました。`,solution:`業種別の入口、課題起点のナビゲーション、段階的な機能説明を設計。デモ予約までの心理的負担を下げるため、料金・導入工程・セキュリティ情報を同一導線に統合しました。`,targets:[`デモ予約率 +28%`,`直帰率 -18%`,`営業説明時間 -20%`],deliverables:[`競合調査`,`情報設計`,`ワイヤーフレーム`,`UIデザイン`,`計測設計`],palette:[`#10130d`,`#d8ff5f`,`#f3f1e9`],source:`https://www.pexels.com/photo/person-using-a-laptop-6802042/`},{id:`nagi`,index:`02`,title:`NAGI`,type:`Boutique hotel / Booking`,role:`Brand direction, UX, UI`,image:`./images/nagi-hotel.webp`,color:`#ff6b42`,statement:`静けさを予約する。海辺の宿のブランド体験。`,challenge:`価格比較に流れやすい宿泊予約で、設備情報だけでは伝わらない滞在価値を可視化し、公式予約を選ぶ理由をつくる課題です。`,solution:`時間帯で変わる過ごし方を物語として構成。部屋・食事・周辺体験を一つの滞在プランとして見せ、日程検索を常に操作できる予約導線を設計しました。`,targets:[`公式予約比率 +15pt`,`客室詳細到達 +35%`,`モバイル離脱 -22%`],deliverables:[`ブランド整理`,`カスタマージャーニー`,`コンテンツ設計`,`UIデザイン`,`予約導線`],palette:[`#24333a`,`#ff6b42`,`#ebe2d4`],source:`https://www.pexels.com/photo/resort-with-swimming-pool-261102/`},{id:`kissa`,index:`03`,title:`KISSA 04`,type:`Coffee roaster / E-commerce`,role:`Art direction, EC design`,image:`./images/kissa-coffee.webp`,color:`#3b63ff`,statement:`味の違いがわかる、迷わないコーヒー選び。`,challenge:`専門用語が多いコーヒーECで、初心者が商品差を理解できず、価格やパッケージだけで選んでしまう状態を想定しました。`,solution:`酸味・コク・香りを直感的なスケールで比較できる商品カードを設計。飲む場面から選ぶ診断と、定期便への自然なアップセルを組み込みました。`,targets:[`商品詳細遷移 +32%`,`定期便選択 +18%`,`カート離脱 -12%`],deliverables:[`商品分類`,`購入フロー`,`アートディレクション`,`UIデザイン`,`EC改善案`],palette:[`#f3c44b`,`#3b63ff`,`#391f17`],source:`https://www.pexels.com/photo/close-up-of-coffee-cup-on-table-302899/`},{id:`michi`,index:`04`,title:`MICHI Clinic`,type:`Healthcare / Service website`,role:`Research, UX, Accessibility`,image:`./images/michi-clinic.webp`,color:`#79d7b4`,statement:`不安なときほど、迷わず予約できる医療サイト。`,challenge:`体調が悪い状況でも診療内容、費用、受診方法をすぐ判断でき、幅広い年齢層が無理なく操作できることが重要です。`,solution:`症状・診療科・受診方法の3方向から探せる情報設計に再編。文字サイズ、コントラスト、キーボード操作を含むWCAG 2.2 AA準拠を設計条件にしました。`,targets:[`予約完了率 +24%`,`電話問い合わせ -18%`,`主要導線 AA準拠`],deliverables:[`ユーザー調査`,`情報設計`,`アクセシビリティ`,`プロトタイプ`,`運用ガイド`],palette:[`#173d35`,`#79d7b4`,`#fffaf0`],source:`https://www.pexels.com/photo/a-doctor-talking-to-a-patient-5452201/`},{id:`machi`,index:`05`,title:`MACHI/MA`,type:`Design festival / Campaign`,role:`Creative direction, Web direction`,image:`./images/machi-festival.webp`,color:`#ffdf00`,statement:`街を歩くこと自体が、イベントになる。`,challenge:`会場が街中に分散するイベントで、来場者が興味に合う企画を発見し、当日の回遊計画まで立てられる体験が必要でした。`,solution:`地図とタイムテーブルを横断するお気に入り機能を中心に設計。会場の混雑・移動時間・現在地を考慮したマイプラン体験を提案しました。`,targets:[`企画保存率 40%`,`回遊会場数 +1.6`,`SNS流入 +30%`],deliverables:[`企画設計`,`サイトマップ`,`クリエイティブ監修`,`UIデザイン`,`運用設計`],palette:[`#191919`,`#ffdf00`,`#f0472e`],source:`https://www.pexels.com/photo/people-at-concert-1190297/`}],t=document.querySelector(`#app`);function n(e){return`
